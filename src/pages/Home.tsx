    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-screen pt-20 flex flex-col items-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-b from-noir-deep/80 via-noir-deep/70 to-noir-deep"></div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto w-full px-6 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-20 md:mb-32">
          ...
          >
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-6xl font-display font-black uppercase tracking-tighter mb-4 md:mb-6 text-white leading-tight">Compañeros <br />& Services</h2>
          ...
          >
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-6xl font-display font-black uppercase tracking-tighter mb-4 md:mb-6 text-gold leading-tight">JBK <br />& Services</h2>
          ...
          >
            {[...PARTNERS, ...PARTNERS, ...PARTNERS].map((partner, idx) => (
              <img 
                ...
                src={partner.logo} 
                alt={partner.name} 
                className="h-10 md:h-14 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer"
              />
            ))}
          </motion.div>
        </div>
